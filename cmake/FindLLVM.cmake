...
execute_process(COMMAND ${LLVM_CONFIG_EXECUTABLE} --ldflags --link-static OUTPUT_VARIABLE LLVM_LDFLAGS OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET)

# Tiago: added --link-static to prefer static linking over 
execute_process(COMMAND ${LLVM_CONFIG_EXECUTABLE} --system-libs --link-static OUTPUT_VARIABLE LLVM_LDFLAGS2 OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET)
string(REPLACE "\n" " " LLVM_LDFLAGS "${LLVM_LDFLAGS} ${LLVM_LDFLAGS2}")
MESSAGE(STATUS "LLVM LD flags: " ${LLVM_LDFLAGS})

# Tiago: added --link-static to prefer static linking over 
exec_program(${LLVM_CONFIG_EXECUTABLE} ARGS --libs --link-static     OUTPUT_VARIABLE LLVM_LIBS_CORE )

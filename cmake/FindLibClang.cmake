...
if (NOT EXISTS ${CLANG_LIB_DIR})
  ...
  if (NOT EXISTS ${CLANG_LIB_DIR})
    message(FATAL_ERROR "Could NOT find clang libdir. You can fix this by setting CLANG_LIB_DIR in your shell or as a cmake variable.")
  endif ()
endif ()

if (NOT CLANG_LIBS)
  find_library(CLANG_LIB_HACK_CMAKECACHE_DOT_TEXT_BULLSHIT NAMES clang libclang ${CLANG_ROOT}/lib ${CLANG_LIB_DIR} NO_DEFAULT_PATH)
  if (NOT EXISTS ${CLANG_CLANG_LIB_HACK_CMAKECACHE_DOT_TEXT_BULLSHIT})
    ...
    if (NOT EXISTS ${CLANG_LIBS})
      set (CLANG_LIBS "-L${CLANG_LIB_DIR}" "-lclang" "-Wl,-rpath,${CLANG_LIB_DIR}")
    endif ()
  else ()
...
message("-- Using Clang \${CLANG_VERSION}=${CLANG_VERSION} from \${CLANG_LIB_DIR}=${CLANG_LIB_DIR} with LIBS ${CLANG_LIBS} and CXXFLAGS ${CLANG_CXXFLAGS}")
